...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'komalrao.vds@gmail.com', // this is the email that will be used to send the email.
        pass: 'majm qesm zyma hbfe', //this is the password that is created in app passwords in gmail setting options.
    },
});
